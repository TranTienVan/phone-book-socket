...
"}")
        ...
        self.plug = QPushButton(self.frame_top)
        self.plug.setObjectName(u"plug")
        self.plug.setMinimumSize(QSize(40, 40))
        self.plug.setMaximumSize(QSize(40, 40))
        self.plug.setCursor(QCursor(Qt.PointingHandCursor))
        self.plug.setStyleSheet(u"background-color: rgb(85, 147, 161);")
        icon1 = QIcon()
        icon1.addFile(u"Resources/plug.png", QSize(), QIcon.Normal, QIcon.Off)
        self.plug.setIcon(icon1)
        self.plug.setIconSize(QSize(25, 25))
        self.plug.setFlat(False)

        self.horizontalLayout_8.addWidget(self.plug)
...
"}")
        ...
        self.search_inp.setToolTip(u"<html><head/><body><p>Enter an ID or '<span style=\" color:#5500ff;\">@All</span>'</p></body></html>")
        ...
        self.log.setGeometry(QRect(150, 160, 431, 20))
        font2 = QFont()
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 679, 359))
...
"}")
        ...
        self.plug_2 = QPushButton(self.info_page)
        self.plug_2.setObjectName(u"plug_2")
        self.plug_2.setGeometry(QRect(610, 310, 40, 40))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
...
#if QT_CONFIG(tooltip)
        self.plug.setToolTip(QCoreApplication.translate("MainWindow", u"Connect", None))
#endif // QT_CONFIG(tooltip)
        self.plug.setText("")
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Search Users", None))
        ...
        self.ID_out.setText(QCoreApplication.translate("MainWindow", u"010393995", None))
        self.ID_out.setPlaceholderText("")
#if QT_CONFIG(tooltip)
        self.plug_2.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.plug_2.setStatusTip(QCoreApplication.translate("MainWindow", u"Back", None))
#endif // QT_CONFIG(statustip)
        self.plug_2.setText("")
        self.name_out.setText(QCoreApplication.translate("MainWindow", u"010393995", None))
        self.name_out.setPlaceholderText("")
        self.phone_out.setText(QCoreApplication.translate("MainWindow", u"010393995", None))
        self.phone_out.setPlaceholderText("")
        self.mail_out.setText(QCoreApplication.translate("MainWindow", u"010393995", None))
